...
function GoogleSheetConnector(options, onLoad) {
    ...
    this.batchUpdateCell = function (data, successCallback, errorCallback) {
        const request = {
            spreadsheetId: _this.spreadsheetId,
            resource: {
              data: data,
        ...
        gapi.client.sheets.spreadsheets.values.batchUpdate(request).then(successCallback, errorCallback);
    };
}
